<?php
  ...
  // connexion réussie
		...
		echo "<table><caption><strong>liste des types d'entreprises de BTS SIO</strong></caption>";
		echo "<thead> <!-- En-tête du tableau -->";
		echo "<tr><th>idType</th>  <th>libelleType</th> </tr>";
		echo "</thead>";
		...
		while($ligne){
			echo "<tr><td>".$ligne->idType."</td>";
			echo "<td>".$ligne->libelleType."</td></tr>";
			$ligne = $resultats->fetch(PDO::FETCH_OBJ) ;
		}
	}
	else{
