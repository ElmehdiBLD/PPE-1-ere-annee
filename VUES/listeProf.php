<?php
  ...
  // connexion réussie
		...
		echo "<table><caption><strong>liste des professeur de BTS SIO</strong></caption>";
		echo "<thead> <!-- En-tête du tableau -->";
		echo "<tr><th>IdProf</th>  <th>nomProf</th><th>prenomProf</th>   <th>adresseEmail</th>    </tr>";
		echo "</thead>";
		...
		while($ligne){
			...
			echo "<td>".$ligne->nomProf."</td>";
			echo "<td>".$ligne->prenomProf."</td>";
			$ligne = $resultats->fetch(PDO::FETCH_OBJ) ;
		}
	}
	else{
