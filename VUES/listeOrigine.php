<?php
  ...
  // connexion réussie
		...
		echo "<table><caption><strong>liste des origines de BTS SIO</strong></caption>";
		echo "<thead> <!-- En-tête du tableau -->";
		echo "<tr><th>idOrigine</th>  <th>libelleOrigine</th> </tr>";
		echo "</thead>";
		...
		while($ligne){
			echo "<tr><td>".$ligne->idOrigine."</td>";
			echo "<td>".$ligne->libelleOrigine."</td>";
			$ligne = $resultats->fetch(PDO::FETCH_OBJ) ;
		}
	}
	else{
